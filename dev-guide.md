...
- `themes/Rob&#39;s Theme-color-theme.json` - the color theme definition file.
...
- To start using your extension with Visual Studio Code copy it into the `<user home>/.vscode/extensions` folder using `make install` and restart Code.
